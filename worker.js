...
If the theme is unsuitable, return exactly: {"error":"<friendly explanation, one sentence, suggest an alternative if possible>"}
...
6. Vary event types within each set.`;
    ...
    const specMap = {
      ...
      historian: 'Archival-level — edicts, minor sieges, court decisions that specialists debate.'
    };
    ...
    const spanMap = {
      ...
      historian: 'Sets may span just a few years or the same year. Exact years are critical.'
    };
